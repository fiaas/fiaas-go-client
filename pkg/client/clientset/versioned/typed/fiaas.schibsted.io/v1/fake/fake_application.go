...
var applicationsResource = schema.GroupVersionResource{Group: "fiaas.schibsted.io", Version: "v1", Resource: "applications"}
...
func (c *FakeApplications) Get(ctx context.Context, name string, options v1.GetOptions) (result *fiaasschibstediov1.Application, err error) {
	...
	return obj.(*fiaasschibstediov1.Application), err
}
...
func (c *FakeApplications) List(ctx context.Context, opts v1.ListOptions) (result *fiaasschibstediov1.ApplicationList, err error) {
	...
	list := &fiaasschibstediov1.ApplicationList{ListMeta: obj.(*fiaasschibstediov1.ApplicationList).ListMeta}
	for _, item := range obj.(*fiaasschibstediov1.ApplicationList).Items {
...
func (c *FakeApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(applicationsResource, c.ns, name, opts), &fiaasschibstediov1.Application{})
