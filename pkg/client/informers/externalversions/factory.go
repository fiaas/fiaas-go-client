...
type SharedInformerFactory interface {
	...
	Fiaas() fiaasschibstedio.Interface
}

func (f *sharedInformerFactory) Fiaas() fiaasschibstedio.Interface {
	return fiaasschibstedio.New(f, f.namespace, f.tweakListOptions)
}
